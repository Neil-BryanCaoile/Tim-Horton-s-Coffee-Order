...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <form name="myform" id="form" action="order.php" method="POST"  onsubmit="return validation()">
                ...
                <div>
                    <div class="outer-radio-container">
                        <div class="radio-container">
                            <label for="small">
                                <img class="cups" id="small-img" src="images/cup.png" alt="small cup" />
                                Small
                            </label>
                        ...
                        <div class="radio-container">
                            <label for="medium">
                                <img class="cups" id="medium-img" src="images/cup.png" alt="medium" />
                                Medium
                            </label>
                        ...
                        <div class="radio-container">
                            <label for="large">
                                <img class="cups" id="large-img" src="images/cup.png" alt="large" />
                                Large
                            </label>
                            <input
                                    type="radio"
                        ...
                        <div class="radio-container">
                            <label for="x-large">
                                <img class="cups" id="x-large-img" src="images/cup.png" alt="x-large" />
                                X-large
                            </label>
                            <input
                                    type="radio"
